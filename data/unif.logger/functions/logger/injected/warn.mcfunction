...
# 打印
execute as @a[tag=unif.debug] if score $level unif.logger matches ..3 run function unif.logger:private/logger/injected_printer with storage unif.logger:warn_logs Logs[-1]