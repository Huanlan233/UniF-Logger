...
# 打印
execute as @a[tag=unif.debug] if score $level unif.logger matches ..2 run function unif.logger:private/logger/_injected_printer with storage unif.logger:info_logs Logs[-1]